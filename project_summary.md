...
The functional prototype is live, here: [artifish.memeticarts.com](http://artifish.memeticarts.com) is live!  This will currently run in your browser, but you need to [download the Unity Plugin](https://unity3d.com/webplayer) first. 
